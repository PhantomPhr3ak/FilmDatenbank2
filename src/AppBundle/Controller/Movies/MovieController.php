...
class MovieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $movies = $em->getRepository('AppBundle:Movies\Movie')->findAll();

        return $this->render('movies/movie/index.html.twig', array(
            'movies' => $movies,
        ));
    }
    ...
    {
        $movie = new Movie();
        $form = $this->createForm('AppBundle\Form\Movies\MovieType', $movie);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('movies_movie_show', array('id' => $movie->getId()));
        }

        return $this->render('movies/movie/new.html.twig', array(
            'movie' => $movie,
    ...
    public function showAction(Movie $movie)
    {
        ...
        return $this->render('movies/movie/show.html.twig', array(
            'movie' => $movie,
    ...
    {
        $deleteForm = $this->createDeleteForm($movie);
        $editForm = $this->createForm('AppBundle\Form\Movies\MovieType', $movie);
        $editForm->handleRequest($request);

        if ($editForm->isSubmitted() && $editForm->isValid()) {
            $this->getDoctrine()->getManager()->flush();

            return $this->redirectToRoute('movies_movie_edit', array('id' => $movie->getId()));
        }

        return $this->render('movies/movie/edit.html.twig', array(
            'movie' => $movie,
